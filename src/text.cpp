...
TextRenderPass::TextRenderPass(GLFWwindow* window) {
    ...
    glm::mat4 projection = glm::perspective(glm::radians(90.0f), (float)width/height, 0.1f, width+height/2.0f);
    projection *= glm::lookAt(glm::vec3(width/2, -height/2, height/2), glm::vec3(width/2, -height/2, 0), glm::vec3(0, 1, 0));
